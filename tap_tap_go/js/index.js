        ...
        const game = {
            ...
            createGameMenu: () => {
                ...
                if (game.conf.isMobile) {
                    game.ctx.font = 'bold 40px Chalkduster fantasy';
                ...
                textDimensions = {
                    ...
                    positionY: game.canvas_el.height * 0.5
                }
            ...
            triggerStartGame: () => {
                ...
                game.gameIntervalId = requestAnimationFrame(game.play);
            },
            ...
            play: () => {
                ...
                if (game.player.isAlive) {
                    ...
                    cancelAnimationFrame(game.gameIntervalId);
